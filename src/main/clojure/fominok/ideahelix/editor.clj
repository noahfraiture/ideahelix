...
(defkeymap
   ...
   (\c "Replace selections"
     ...
     (let [start (start-undo project editor)]
       (WriteCommandAction/runWriteCommandAction
         project
         (fn [] (for-each-caret editor #(do (delete-selection-contents document %)
  ...
  (:normal
    ...
    ((:or \j KeyEvent/VK_DOWN) "Move carets down" :undoable
     [document caret] (move-caret-down document caret)
     [editor] (scroll-to-primary-caret editor))
    ((:or \k KeyEvent/VK_UP) "Move carets up" :undoable
     [document caret] (move-caret-up document caret)
     [editor] (scroll-to-primary-caret editor))
    ((:or \h KeyEvent/VK_LEFT) "Move carets left" :undoable
     [document caret] (move-caret-backward document caret)
     [editor] (scroll-to-primary-caret editor))
    ((:or \l KeyEvent/VK_RIGHT) "Move carets right" :undoable
  ...
  (:select
    ...
    ((:or \j KeyEvent/VK_DOWN) "Move carets down extending" :undoable
     [document caret] (extending document caret (partial move-caret-down document))
     [editor] (scroll-to-primary-caret editor))
    ((:or \k KeyEvent/VK_UP) "Move carets up extending" :undoable
     [document caret] (extending document caret (partial move-caret-up document))
     [editor] (scroll-to-primary-caret editor))
    ((:or \h KeyEvent/VK_LEFT) "Move carets left extending" :undoable
     [document caret] (extending document caret (partial move-caret-backward document))
     [editor] (scroll-to-primary-caret editor))
    ((:or \l KeyEvent/VK_RIGHT) "Move carets right extending" :undoable
